...
export function HistoryPanel({ configurations, onClose, onRunAgain }: { configurations: Configuration[]; onClose: () => void; onRunAgain: (execution: Execution) => void }) {
